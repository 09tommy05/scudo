<template>
  <div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-8 text-primary">Articoli e Guide</h1>
...
const categories = ref(['Sicurezza', 'Privacy', 'Social Media', 'Tecnologia']); // Potrebbero essere caricati dinamicamente
