      ...
      <section class="container mx-auto px-4 lg:px-8 pb-16">
        <div class="grid lg:grid-cols-3 gap-6 lg:items-stretch">
          ...
          <div class="lg:col-span-2 flex flex-col gap-6 min-h-0">
            <img src="/immagine_mail.png" alt="Esempio di email di phishing con segnali di pericolo evidenziati" class="w-full h-auto max-h-[720px] object-contain block shrink-0" />
