    ...
    <section class="container mx-auto px-4 lg:px-8 pb-16">
      <div class="grid lg:grid-cols-3 gap-6 lg:items-stretch">
        ...
        <div class="lg:col-span-2 flex flex-col gap-6 min-h-0">
          <img src="/immagine_mail.png" alt="Esempio di email di phishing con segnali di pericolo evidenziati"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 text-center">
                <div
                  ...
                  1</div>
                <h4 class="text-sm font-bold uppercase tracking-wider text-primary mb-2">Mittente</h4>
                <p class="text-sm text-gray-500 leading-relaxed">Nome e logo sospetti che imita l'originale. Controlla
                  sempre attentamente l'indirizzo email dopo il simbolo @.</p>
              </div>
              <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 text-center">
                <div
                  class="w-10 h-10 rounded-full bg-primary text-white text-sm font-bold flex items-center justify-center mx-auto mb-3 shadow">
                  2</div>
                <h4 class="text-sm font-bold uppercase tracking-wider text-primary mb-2">Tono urgente</h4>
                <p class="text-sm text-gray-500 leading-relaxed">Pressione psicologica per farti agire in fretta senza
                  riflettere. L'urgenza è un'arma classica del phishing.</p>
              </div>
              <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 text-center">
                <div
                  class="w-10 h-10 rounded-full bg-primary text-white text-sm font-bold flex items-center justify-center mx-auto mb-3 shadow">
                  3</div>
                <h4 class="text-sm font-bold uppercase tracking-wider text-primary mb-2">Link/bottone</h4>
                <p class="text-sm text-gray-500 leading-relaxed">Punta a un sito falso (simile all'originale) creato per
                  rubare le tue credenziali. Non cliccare su nessun bottone o link.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="space-y-3 lg:flex-1 lg:min-h-0 lg:overflow-y-auto scrollbar-hide">
              <div class="bg-white rounded-xl p-4 shadow-sm flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-500 leading-relaxed mt-0.5">Inserisci l'indirizzo nella lista dei bloccati
                    del tuo client email.</p>
                </div>
              </div>
              <div class="bg-white rounded-xl p-4 shadow-sm flex items-start gap-3">
              ...
              <div class="bg-white rounded-xl p-4 shadow-sm flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-500 leading-relaxed mt-0.5">Usa i canali ufficiali per segnalare il
                    tentativo di phishing.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="space-y-3 lg:flex-1 lg:min-h-0 lg:overflow-y-auto scrollbar-hide">
              ...
              <div class="bg-white rounded-xl p-4 shadow-sm flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-500 leading-relaxed mt-0.5">Confermeresti che il tuo indirizzo è attivo,
              ...
              <div class="bg-white rounded-xl p-4 shadow-sm flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-500 leading-relaxed mt-0.5">Nessun servizio legittimo chiede password o
                    dati sensibili via email.</p>
                </div>
              </div>
            </div>
          </div>
