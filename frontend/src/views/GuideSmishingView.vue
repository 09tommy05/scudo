  ...
  <div class="flex flex-col">
    ...
    <section class="text-center py-10 md:py-14">
      ...
      <p class="text-gray-500 text-base md:text-lg max-w-2xl mx-auto">
        Non farti ingannare dallo Smishing. Impara a riconoscere i segnali di pericolo in pochi secondi e proteggi il
        tuo conto.
      </p>
    </section>
    ...
    <section class="container mx-auto px-4 lg:px-8 pb-16">
      <div class="grid lg:grid-cols-3 gap-6 lg:items-stretch">
        ...
        <div class="lg:col-span-2 flex flex-col gap-6 min-h-0">
          <img src="/immagine_telefono.png" alt="Esempio di SMS di smishing con segnali di pericolo evidenziati"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 text-center">
                <div
                  ...
                  1</div>
                <h4 class="text-sm font-bold uppercase tracking-wider text-primary mb-2">Mittente sconosciuto</h4>
                <p class="text-sm text-gray-500 leading-relaxed">Le banche usano mittenti testuali (es. "BANCA") o
                  numeri certificati, non cellulari privati.</p>
              </div>
              <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 text-center">
                <div
                  class="w-10 h-10 rounded-full bg-primary text-white text-sm font-bold flex items-center justify-center mx-auto mb-3 shadow">
                  2</div>
                <h4 class="text-sm font-bold uppercase tracking-wider text-primary mb-2">Link sospetto</h4>
                <p class="text-sm text-gray-500 leading-relaxed">Uso di abbreviatori (bit.ly) o domini simili ma errati.
                  Controlla sempre l'URL ufficiale.</p>
              </div>
              <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 text-center">
                <div
                  class="w-10 h-10 rounded-full bg-primary text-white text-sm font-bold flex items-center justify-center mx-auto mb-3 shadow">
                  3</div>
                <h4 class="text-sm font-bold uppercase tracking-wider text-primary mb-2">Urgenza fasulla</h4>
                <p class="text-sm text-gray-500 leading-relaxed">Il linguaggio mira a spaventarti ("blocco permanente")
                  per farti agire senza pensare.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="space-y-3 lg:flex-1 lg:min-h-0 lg:overflow-y-auto scrollbar-hide">
              <div class="bg-white rounded-xl p-4 shadow-sm flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-500 leading-relaxed mt-0.5">Inserisci il numero nella lista nera del tuo
                    smartphone.</p>
                </div>
              </div>
              <div class="bg-white rounded-xl p-4 shadow-sm flex items-start gap-3">
                ...
                <div>
                  <p class="font-bold text-gray-900 text-sm">Elimina lo SMS</p>
                  <p class="text-sm text-gray-500 leading-relaxed mt-0.5">Rimuovi il messaggio definitivamente per
                    evitare tocchi accidentali.</p>
                </div>
              </div>
              <div class="bg-white rounded-xl p-4 shadow-sm flex items-start gap-3">
                <div class="w-9 h-9 rounded-lg bg-green-600 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-500 leading-relaxed mt-0.5">Usa i canali ufficiali per avvisare del
                    tentativo di frode.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="rounded-2xl overflow-hidden p-4 lg:flex-1 lg:min-h-0 lg:flex lg:flex-col"
            ...
            <div class="space-y-3 lg:flex-1 lg:min-h-0 lg:overflow-y-auto scrollbar-hide">
              <div class="bg-white rounded-xl p-4 shadow-sm flex items-start gap-3">
                ...
                <div>
                  <p class="font-bold text-gray-900 text-sm">Non cliccare il link</p>
                  <p class="text-sm text-gray-500 leading-relaxed mt-0.5">Potrebbe scaricare malware o rubare le tue
                    credenziali.</p>
                </div>
              </div>
              <div class="bg-white rounded-xl p-4 shadow-sm flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-500 leading-relaxed mt-0.5">Confermeresti che il tuo numero è attivo,
                    attirando altri attacchi.</p>
                </div>
              </div>
              <div class="bg-white rounded-xl p-4 shadow-sm flex items-start gap-3">
                <div class="w-9 h-9 rounded-full bg-red-600 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-500 leading-relaxed mt-0.5">Nessuna banca chiede PIN o password via SMS.
                  </p>
                </div>
              </div>
            </div>
